...
* [surveytable: functions for tabulating survey estimates](https://cdcgov.github.io/surveytable/)
* [nchsdata: public use files (PUFs) from the the National Center for Health Statistics (NCHS)](https://cdcgov.github.io/nchsdata/)
* [importsurvey: functions for importing data into R](https://cdcgov.github.io/importsurvey/)
