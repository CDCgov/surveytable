...
* `nopwu` = No other payment was used, such as private, Medicare, etc.
...
The variable `Age group` has already been created in a previous example. Cross `AGER` and `SEX` to create a variable called `Age x Sex`: 
