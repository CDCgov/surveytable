...
This table shows the same information as Table 3, but only for preventive care visits. That is, it's estimates for each age group, as well as for each age group by sex, but only for preventive care visits.
