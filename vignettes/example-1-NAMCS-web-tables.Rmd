---
title: "Example 1: NAMCS web tables"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{example-1-NAMCS-web-tables}
...
Selected variables from NAMCS 2019 come with the `surveytable` package, in an object called `vars2019`. This object is enough to recreate the tables. Alternatively, to access the full NAMCS 2019, use `nchsdata::namcs2019`.

To make the below code more reusable, we'll call the survey by a generic name -- `mysurvey`.
