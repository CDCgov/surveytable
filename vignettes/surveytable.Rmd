...
Selected variables from NAMCS 2019 come with the `surveytable` package, in an object called `vars2019`. Alternatively, to access the full NAMCS 2019, use `nchsdata::namcs2019`.
