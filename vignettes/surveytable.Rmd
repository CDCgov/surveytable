...
To test whether, for each possible pair of levels of the categorical variable `AGER`, the numeric variable `NUMMED` is statistically similar or different, type:
