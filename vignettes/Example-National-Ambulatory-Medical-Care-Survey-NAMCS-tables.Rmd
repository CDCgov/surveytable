...
Recall that survey objects have an element called `variables`, which is a data frame that contains the survey variables. 
...
* After making changes to `mysurvey`, we need to call `set_survey()` again.
